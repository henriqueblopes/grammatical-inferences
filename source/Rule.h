...
public:
    ...
    std::pair<std::vector<Symbol>,std::pair<double, double>> getRightSidebyId(unsigned int id1stNonContext,unsigned  int id2ndNonContext, bool terminal, int nNonterminals);
    double freq();
private:
    double cConstant();
};
